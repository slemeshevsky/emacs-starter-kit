...
(when (file-exists-p "~/Projects/cds/gui/cds.pro")
 (setq cds-project
        (ede-cpp-root-project "gui"
                              ...
                              :include-path '( "/", "../interfaces")
                              :compile-command "cd ~/Projects/build/cds && qmake-qt4 ../../cds/gui/cds.pro && make"
                              )))
#+end_src
*** Проект ~segmentation~
#+begin_src emacs-lisp
(when (file-exists-p "~/Projects/cds/segmentation/segmentation.pro")
 (setq segmentation-project
        (ede-cpp-root-project "segmentation"
                              ...
                              :include-path '( "/", "../interfaces")
                              :compile-command "cd ~/Projects/build/cds && qmake-qt4 ../../cds/segmentation/segmentation.pro && make"
                              )))
#+end_src
